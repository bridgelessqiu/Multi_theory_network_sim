...
# def correlate_threshold_prob(A, B, prob, k, r = 0, hub = False, clust = False):
#     """
#         Description
#         -----------
#         This function simulate the spread of multiple contigions on a single network
...
#         prob: function, returns float (0, 1)
#           The probability function. Returns the probabiltiy of updating states to 1
